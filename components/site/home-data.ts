...
export const FOOTER = {
  about: "Carvi Associates is a modern finance, business & consulting practice helping individuals and companies plan, invest, and grow with confidence.",
  linksColumnOne: [
    { label: "About Us", href: "#" },
    { label: "Contact", href: "#" },
    { label: "Faqs", href: "#" },
  ...
  recentBlog: [
    { title: "This Specific Issue Network Security", date: "10 May 2024", image: "/images/blog/footer-blog-1-1.jpg" },
    { title: "In up So Discovery my Middleton", date: "23 February 2025", image: "/images/blog/footer-blog-1-2.jpg" },
  ],
  bottomLinks: [
    { label: "Privacy", href: "#" },
    { label: "Policy", href: "#" },
