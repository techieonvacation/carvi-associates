...
export function Footer({ footer }: FooterProps) {
  ...
  const socials = footer.socials
    .filter((social) => social.isVisible && social.isActive)
    .map((social) => ({
      label: social.label,
      href: social.href,
      icon: social.icon,
  ...
  return (
    <footer className="main-footer relative overflow-hidden bg-accent text-white">
      <div
        ...
        style={{ backgroundImage: `url(${footer.backgroundImageUrl})` }}
        aria-hidden="true"
      />
      ...
      <div className="main-footer__top relative overflow-hidden pt-[223px] pb-[70px] max-xl:pt-40 max-lg:pt-28 max-md:pt-20">
        ...
        <Container className="relative z-[1]">
          <div className="grid grid-cols-12 gap-x-6 gap-y-10">
            ...
            {footer.showLinks &&
            (footer.linksColumnOne.length || footer.linksColumnTwo.length) ? (
              <Reveal
                direction="up"
                delay={200}
              ...
              >
                <div className="footer-widget footer-widget--links footer-widget--links-1 mt-0 pl-0 md:pl-5 lg:pl-10 xl:mt-5 xl:pl-[70px]">
                  <h2 className="footer-widget__title mb-[34px] text-[22px] leading-[1.363] font-bold capitalize text-white">
                    {footer.linksTitle}
                  </h2>
            ...
            {footer.showExplore && footer.explore.length ? (
              <Reveal
                direction="up"
                delay={300}
            ...
            {footer.showRecentBlog && footer.recentBlog.length ? (
              <Reveal
                direction="up"
                delay={400}
                    ...
                    {footer.recentBlog.map((post) => (
                      ...
                      >
                        ...
                        <div className="footer-widget__blog__content">
                          ...
                          <h3 className="footer-widget__blog__title m-0 text-base leading-[1.375] font-semibold text-white">
                            <Link
                              href={post.href || "#"}
          ...
          <Container>
            <div className="main-footer__bottom__inner flex flex-col-reverse items-center justify-center gap-x-[30px] gap-y-[25px] border-t border-white/30 py-[30px] text-center lg:flex-row lg:justify-between lg:py-[25px] lg:text-left">
              <p className="main-footer__copyright m-0 text-base font-normal text-white capitalize">
                &copy; Copyright {year} {footer.copyrightText}
              </p>
